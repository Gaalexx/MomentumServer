...
import com.example.database.ReactionsTable.deleteAllReactions
import com.example.database.ReactionsTable.deleteReactionsOnUserPosts
        ...
        return withContext(kotlinx.coroutines.Dispatchers.IO) {
            transaction {
                try {
                    ...
                    deleteReactionsOnUserPosts(userPostIds)
